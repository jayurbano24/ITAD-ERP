...
-- Este script corrige los triggers de auditoría reemplazando
-- row_to_json() por to_jsonb() para permitir comparaciones
-- =================================================================

-- 1. Corregir trigger de tickets (donde ocurrió el error reportado)
...
BEGIN
    ...
    ELSE
        -- CORRECCIÓN AQUÍ: Usar to_jsonb() en lugar de row_to_json() para comparar
...
-- 2. Corregir trigger de Work Orders (prevención)
...
-- 3. Corregir trigger de Assets (prevención)
