-- ============================================================
-- PASO 2: EJECUTA ESTO DESPUÉS DE 5-10 SEGUNDOS DEL PASO 1
-- EN UNA NUEVA PESTAÑA O VENTANA DE SQL
-- ============================================================
...
<body>
    ...
    to_jsonb(ARRAY['{Company Name}', '{Company NIT}', '{Company Address}', '{Company Phone}', '{Manifest Number}', '{Date}', '{Ticket Number}', '{Collector Name}', '{Collection Date}', '{Client Name}', '{Client NIT}', '{Client Address}', '{Client Phone}', '{Box Count}', '{Equipment Count}', '{Equipment Type}', '{Notes}']),
    true
