# 🔧 PASOS PARA EJECUTAR LA MIGRACIÓN FINANCIERA

## Problema
Error: `column "expense_type" does not exist` en `expense_ledger`

## Solución

Las tablas financieras (`settlements`, `expense_ledger`, `revenue_ledger`) aún no existen en Supabase.

### Opción 1: Ejecutar desde Supabase Dashboard (RECOMENDADO)

1. **Abre Supabase Dashboard**
   - Ve a: https://app.supabase.com
   - Selecciona tu proyecto ITAD

2. **Abre SQL Editor**
   - Click en "SQL Editor" en el panel izquierdo
   - Click en "+ New Query"

3. **Copia todo el SQL siguiente:**
...
5. **Verifica que se creó**
   - Ve a "Table Editor"
   - Deberías ver: `settlements`, `expense_ledger`, `revenue_ledger`
...
Esto ejecutará la migración en `supabase/migrations/20260111_create_financial_tables.sql`
...
AND table_name IN ('settlements', 'expense_ledger', 'revenue_ledger');
```
...
Una vez completado, la aplicación dejará de mostrar:
- ❌ `ERROR: 42703: column "expense_type" does not exist`

Y podrá:
- ✅ Calcular P&L de lotes
- ✅ Crear liquidaciones
