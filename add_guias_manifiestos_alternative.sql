...
-- Si el enum aún no tiene "logistica", usa este SQL en orden:

-- PASO 1: Verificar y agregar 'logistica' al enum (ejecuta esto primero)
DO $$
BEGIN
    -- Intenta agregar el valor si no existe
    IF NOT EXISTS (
...
-- Espera 2-3 segundos para que PostgreSQL procese

-- PASO 2: Ahora inserta la plantilla (ejecuta esto después)
